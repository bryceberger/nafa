...
mod tests {
    use super::*;
    use crate::{devices, fake_backend::FakeBackend};

    fn get_devices() -> HashMap<u32, DeviceInfo> {
        devices::builtin().collect()
    }

    fn get_backend() -> FakeBackend {
        FakeBackend::new(0x0362D093)
    }

    #[test]
    fn example_init() {
        let mut cont = Controller::new(get_backend(), &get_devices()).unwrap();
        insta::assert_snapshot!(cont.backend().consume_waveform(), @r"
        ┌Signals┐┌Waves───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
        │tck    ││┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐│
        │       ││┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└│
        │tms    ││ ┌───────────────────┐ ┌─┐                                                                                                                                 ┌───┐│
    ...
    fn example_simple() {
        let mut cont = Controller::new(get_backend(), &get_devices()).unwrap();
        cont.backend().consume_waveform();
        cont.run([Command::ir(0x01)]).unwrap();
        insta::assert_snapshot!(cont.backend().consume_waveform(), @r"
        ┌Signals┐┌Waves───────────────────────────────┐
        │tck    ││┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐┌┐│
        │       ││┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└┘└│
